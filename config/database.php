    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('AZURE_MYSQL_DBNAME', 'msdocs-laravel-mysql-444-database'),
            'username' => env('AZURE_MYSQL_USERNAME', 'jxjazsfefd'),
            'password' => env('AZURE_MYSQL_PASSWORD', '6omO19gCdz$j4xX'),
